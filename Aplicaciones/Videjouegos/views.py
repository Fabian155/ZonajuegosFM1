...
def listarVideojuegos(request):
    ...
    return render(request, "Videojuego/inicio1.html", {'videojuegos': listaJuegos})
...
def editarVideojuego(request, id):
    ...
    plataformas = Plataforma.objects.all()  # Obtener todas las plataformas disponibles
    return render(request, "Videojuego/editarJuego.html", {'videojuego': videojuego, 'plataformas': plataformas})
